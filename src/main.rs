...
fn main() -> ! {
    ...
    let mut leds: [Pin<mode::Output>; 3] = [
    ...
    loop {
        ...
        ufmt::uwriteln!(&mut serial, "Current read: {}", current_read).void_unwrap();
        ...
        ufmt::uwrite!(&mut serial, "Leds: {}", uFmt_f32::Two(num_leds_on as f32)).void_unwrap();
